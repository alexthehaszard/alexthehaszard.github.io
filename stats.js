    ...
    this.showStats = function (solve1, solve2) {
        if (solve1 != undefined) {
            ...
            if (width > height) {
                ...
                if (splitSolve1[0] == "4x4") {
                    text(splitSolve1[2], width / 6 + width / 50, height - height / 13, width / 3 - width / 40, height - height / 80);
                } else {
                    text(splitSolve1[2], width / 6 + width / 60, height - height / 16, width / 3 - width / 50, height - height / 80);
                }
            }
        }
        if (solve2 != undefined) {
            ...
            if (width > height) {
                ...
                if (splitSolve2[0] == "4x4") {
                    text(splitSolve2[2], width / 2 + width / 12, height - height / 13, width / 3 - width / 40, height - height / 80);
                } else {
                    text(splitSolve2[2], width / 2 + width / 12, height - height / 16, width / 3 - width / 50, height - height / 80);
                }
            }
        }
    }
